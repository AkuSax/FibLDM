...
CONTROLNET_CHECKPOINT="../model_runs/controlnet_run_6/controlnet_epoch_50.pth"  # Adjust epoch number
...
# Output directory
OUTPUT_DIR="../model_runs/controlnet_run_6/controlnet_samples"
